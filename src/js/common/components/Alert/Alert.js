                ...
                <section className="top-bar-row py-5">
                    <div className="container">
                        ...
                        <div className="d-flex justify-content-between website">
                            <h2 className="heading-font mb-3">Email alerts</h2>
                            <button type="button" className="btn btn-primary website-btn" onClick={() => this.goCreateAlert()}>
                        ...
                        <div className="row d-md-flex website py-2">
                            <div className="col-md-12">
                                <p>Get notified when a website sends an email containing speficic subject line words</p>
                            </div>
