...
import { adminAsUserLogin } from '../../../api/commonApi';
...
class AdminAsUser extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            email: '',
        ...
        if (localStorage.getItem("catchLetterDetails")) {
            ...
            this.props.onHistory.push({ pathname: "/adminLogin" });
        }
    ...
    handleSubmit(event) {
        if (this.state.email && this.state.password) {
            if (this.state.rememberme == false) {
                ...
                adminAsUserLogin(data).then((res) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminAsUser);
