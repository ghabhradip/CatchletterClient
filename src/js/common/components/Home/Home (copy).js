...
class Home extends Component {
    ...
    search(nameKey, myArray) {
        ...
        for (var i = 0; i < myArray.length; i++) {
            if (myArray[i].month === nameKey) {
                ...
                // console.log("toreturnArray :", toreturnArray);
                // return myArray[i];
            }
        }
        if (toreturnArray.length > 0) {
            let toreturnObj = { data: toreturnArray };
            console.log("toreturnObj :", toreturnObj);
            return toreturnObj;
        }
    }
    ...
    getNoOfMailsByWebsite(emailDomain, unique_id) {
        ...
        if (emailDomain && unique_id) {
            ...
            getListOfMailsByWebsite(data).then((res) => {
                ...
                if (res) {
                    // let filterDataArray = [];
                    // let firstObj={header:{date:["Mon, 23 Jul 2018 16:36:52 +0530"],from:["Subhajit Nag <subhajit.nag2805@gmail.com"]}}
                    // filterDataArray.push(firstObj);
                    // let secondObj={header:{date:["Sun, 24 Jun 2018 16:36:52 +0530"],from:["Subhajit Nag <subhajit.nag2805@gmail.com"]}}
                    // filterDataArray.push(secondObj);
                    // let thirdObj={header:{date:["Fri, 03 Aug 2018 16:36:52 +0530"],from:["Subhajit Nag <subhajit.nag2805@gmail.com"]}}
                    // filterDataArray.push(thirdObj);
                    // let fourthObj={header:{date:["Mon, 06 Aug 2018 16:36:52 +0530"],from:["Subhajit Nag <subhajit.nag2805@gmail.com"]}}
                    // filterDataArray.push(fourthObj);
                    let filterDataArray = res.data.data.message;
                    let totalData = [];
                    filterDataArray.map((item) => {
    ...
    //             if (item.website_name == event.target.value) {
    //                 unique_id = item.unique_id;
    //                 emailDomain = item.emailDomain;
    //             }
    //         })
    //         this.setState({ selectedWesbite: event.target.value, allWebsitesData: '' })
    //         this.getNoOfMailsByWebsite(emailDomain, unique_id);
    //     }
    //     else {
    //         this.setState({ monthlyLineData: '', selectedWesbite: '' })
    //     }
                        ...
                        <div className="container">

                            {
                                ...
                                this.state.allWebsitesData ? (
                                    <div>
                                        <p>Graph for All Websites</p>
                                        <Line data={this.state.allWebsitesData} width="600" height="250" />
                                    </div>
                        ...
                        <div className="container">

                            {
                                this.state.monthlyLineData ? (
                                    <div>
                                        <p>Graph for {this.state.selectedWesbite}</p>
                                        <Line data={this.state.monthlyLineData} width="600" height="250" />
                                    </div>
                    ...
                    <div className="list-table">
                        <div className="container">
                            <div className="top-statics">
                                ...
                                <ul className="clearfix list-inline mb-5">
                                    <li>
                                        <div className="text-left">
                                            <p>today</p>
                                            <p><strong>{this.state.todaysMailCount} Email(s) </strong></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="text-center">
                                            <p>Last 7 Day</p>
                                            <p><strong>{this.state.sevenDaysMailCount} Email(s) </strong></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="text-center">
                                            <p>Last 30 Day</p>
                                            <p><strong>{this.state.thirtyDaysMailCount} Email(s) </strong></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="text-center">
                                            <p>All time</p>
                                            <p><strong>{this.state.totalMailCount} Email(s) </strong></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
